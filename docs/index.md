...
- [Book Search Endpoint Reference](open-lib-book-api) 
...
**Improvements**  
In this portfolio piece, I documented the call and response parameters for the Book Search endpoint. The existing documentation was fragmented, so I produced a comprehensive reference by testing the endpoint directly, inferring parameter behavior from the live application, and cross-referencing original sources.
